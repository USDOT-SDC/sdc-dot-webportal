...
let RESPONSE2 = { 'exportRequests': [{"exportWorkflow":"WAZE","Type":"Algorithm","Owner":"SDC platform","filename":"tempFile1"},{"exportWorkflow":"testuser@gmail.com","Type":"Algorithm","Owner":"Other platform","filename":"tempFile2"},{"exportWorkflow":"testuser@gmail.com","Type":"Other Algorithm","Owner":"SDC platform"},{"exportWorkflow":"testuser@gmail.com","Type":"Other Algorithm","Owner":"Other SDC platform"}] };

let RESPONSE = [ {'userFullName' : 'Cheryl Rousseau', 'description': "Test dummy description", 'team': "team bucket 1",
...
describe('ExportRequestsComponent', () => {
  ...
  it('should open and close renderApprovalForm dialog box', () => {
    let approvalForm = { 'ApprovalForm': {'justifyExport' : 'justifyExport'}};
